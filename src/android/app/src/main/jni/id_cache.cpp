...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    s_savestate_info_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/lime3ds/lime3ds/NativeLibrary$SaveStateInfo")));
    s_core_error_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/lime3ds/lime3ds/NativeLibrary$CoreError")));

    // Initialize NativeLibrary
    const jclass native_library_class = env->FindClass("io/github/lime3ds/lime3ds/NativeLibrary");
    s_native_library_class = reinterpret_cast<jclass>(env->NewGlobalRef(native_library_class));
    s_on_core_error = env->GetStaticMethodID(
        s_native_library_class, "onCoreError",
        "(Lio/github/lime3ds/lime3ds/NativeLibrary$CoreError;Ljava/lang/String;)Z");
    ...
    const jclass cheat_class =
        env->FindClass("io/github/lime3ds/lime3ds/features/cheats/model/Cheat");
    ...
    // Initialize GameInfo
    const jclass game_info_class = env->FindClass("io/github/lime3ds/lime3ds/model/GameInfo");
    ...
    s_disk_cache_progress_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/lime3ds/lime3ds/utils/DiskShaderCacheProgress")));
    jclass load_callback_stage_class =
        env->FindClass("io/github/lime3ds/lime3ds/utils/DiskShaderCacheProgress$LoadCallbackStage");
    s_disk_cache_load_progress = env->GetStaticMethodID(
        s_disk_cache_progress_class, "loadProgress",
        "(Lio/github/lime3ds/lime3ds/utils/DiskShaderCacheProgress$LoadCallbackStage;II)V");
    ...
    const auto to_java_load_callback_stage = [env,
        ...
        return env->NewGlobalRef(env->GetStaticObjectField(
            ...
            env->GetStaticFieldID(load_callback_stage_class, stage.c_str(),
                                  "Lio/github/lime3ds/lime3ds/utils/"
    ...
    s_cia_install_helper_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/lime3ds/lime3ds/utils/CiaInstallWorker")));
    ...
    jclass cia_install_status_class =
        env->FindClass("io/github/lime3ds/lime3ds/NativeLibrary$InstallStatus");
