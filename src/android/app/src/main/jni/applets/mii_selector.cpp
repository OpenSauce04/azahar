...
void InitJNI(JNIEnv* env) {
    s_mii_selector_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/lime3ds/lime3ds/applets/MiiSelector")));
    s_mii_selector_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/lime3ds/lime3ds/applets/MiiSelector$MiiSelectorConfig")));
    s_mii_selector_data_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/lime3ds/lime3ds/applets/MiiSelector$MiiSelectorData")));

    s_mii_selector_execute = env->GetStaticMethodID(
        s_mii_selector_class, "Execute",
        "(Lio/github/lime3ds/lime3ds/applets/MiiSelector$MiiSelectorConfig;)Lio/"
