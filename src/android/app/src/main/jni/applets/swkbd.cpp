...
void InitJNI(JNIEnv* env) {
    s_software_keyboard_class = reinterpret_cast<jclass>(
        env->NewGlobalRef(env->FindClass("io/github/lime3ds/lime3ds/applets/SoftwareKeyboard")));
    s_keyboard_config_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/lime3ds/lime3ds/applets/SoftwareKeyboard$KeyboardConfig")));
    s_keyboard_data_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/lime3ds/lime3ds/applets/SoftwareKeyboard$KeyboardData")));
    s_validation_error_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("io/github/lime3ds/lime3ds/applets/SoftwareKeyboard$ValidationError")));

    s_swkbd_execute =
        env->GetStaticMethodID(s_software_keyboard_class, "Execute",
                               "(Lio/github/lime3ds/lime3ds/applets/"
                               "SoftwareKeyboard$KeyboardConfig;)Lio/github/lime3ds/lime3ds/"
...
jobject ToJavaValidationError(Frontend::ValidationError error) {
    ...
    return env->GetStaticObjectField(
        ...
        env->GetStaticFieldID(
            ...
            "Lio/github/lime3ds/lime3ds/applets/SoftwareKeyboard$ValidationError;"));
}

jobject Java_io_github_lime3ds_lime3ds_applets_SoftwareKeyboard_ValidateFilters(JNIEnv* env,
                                                                                jclass clazz,
                                                                                jstring text) {
...
jobject Java_io_github_lime3ds_lime3ds_applets_SoftwareKeyboard_ValidateInput(JNIEnv* env,
                                                                              jclass clazz,
                                                                              jstring text) {
